...
namespace Microsoft.ProjectOxford.Face.Controls
{
    ...
    internal static class UIHelper
    {
        ...
        internal static IEnumerable<Face> CalculateFaceRectangleForRendering(object faces, int maximagesizes, Tuple<int, int> imageInfo)
        {
            throw new NotImplementedException();
        }

        internal static IEnumerable<Face> CalculateFaceRectangleForRendering(object faces, object maxImageSize, Tuple<int, int> imageInfo)
        {
            throw new NotImplementedException();
        }

        internal static IEnumerable<Face> CalculateFaceRectangleForRendering(IEnumerable<Contract.Face> faces, object maxImageSize, Tuple<int, int> imageInfo)
        {
            throw new NotImplementedException();
        }
